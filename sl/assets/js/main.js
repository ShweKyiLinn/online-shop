const searchButtom = document.getElementById('search-buttom'),
...
let swiperFeatured = new Swiper('.featured__swiper', {
  ...
  let swiperTest = new Swiper('.test__swiper', {
    loop: true,
    spaceBetween: 16,
    grabCursor: true,
    slidesPerView: 'auto',
...
sr.reveal('.home__data, .featured__container, .new__container, .join__data, .test, .footer')
